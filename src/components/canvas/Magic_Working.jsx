...
class CreateParticles {
  ...
  async loadShaderFile(shaderFilePath) {
    ...
    `;
      ...
      vertexShader: vertexShaderSource,  // Use the loaded vertex shader code
      fragmentShader: fragmentShaderSource,  // Use the loaded fragment shader code
